...
CREATE TABLE IF NOT EXISTS ingrediente (
  ...
  CONSTRAINT `fk_Ingrediente_Proveedor` FOREIGN KEY (`codigo_proveedor`) REFERENCES `db_cocina_coder`.`proveedor` (`codigo`))
...
CREATE TABLE IF NOT EXISTS receta_ingrediente (
    ...
    CONSTRAINT `fk_receta` FOREIGN KEY (`id_receta`) REFERENCES `db_cocina_coder`.`receta`(`id_receta`) ON DELETE CASCADE,
    CONSTRAINT `fk_ingrediente` FOREIGN KEY (`id_ingrediente`) REFERENCES `db_cocina_coder`.`ingrediente`(`id_ingrediente`))
